...
var KTAppEcommerceSaveProduct=function(){
	...
	return{
		...
		init:function(){
			...
			"#kt_ecommerce_add_product_meta_description"].forEach((e=>{
						...
						$(t).on("change",
							(function(t){
								...
								switch(t.target.value){
									...
									case"published":e.classList.remove(...o),
									e.classList.add("bg-success"),
									c();

									break;

									case"scheduled":e.classList.remove(...o),
									e.classList.add("bg-warning"),
									d();

									break;

									case"inactive":e.classList.remove(...o),
									e.classList.add("bg-danger"),
									c();

									break;

									case"draft":e.classList.remove(...o),
							...
							e.addEventListener("change",
								(e=>{
									...
									switch(e.target.value){
										...
										case"2":t.classList.remove("d-none"),
										o.classList.add("d-none");

										break;

										case"3":t.classList.add("d-none"),
										o.classList.remove("d-none");

										break;

										default:t.classList.add("d-none"),
										o.classList.add("d-none")
						...
						o.addEventListener("click",
							(a=>{
								...
								e&&e.validate().then((function(e){
									...
									"Valid"==e?(o.setAttribute("data-kt-indicator",
										"on"),
									o.disabled=!0,
									setTimeout((function(){

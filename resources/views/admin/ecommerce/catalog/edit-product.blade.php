		...
		<form id="kt_ecommerce_edit_product_form" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row" data-kt-redirect="/admin/catalog/products">
			...
			<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
							...
							<div class="card card-flush py-4">
								...
								<div class="card-body pt-0">
									...
									<div class="fv-row">
										...
										<!--end::Label-->
										<!--begin::Editor-->
										<textarea class="form-control" name="product_description" rows="4" placeholder="Product description">{{$product->description}}</textarea>
										<!--end::Editor-->
										<!--begin::Description-->
				...
				<div class="d-flex justify-content-end">
					<!--begin::Button-->
					<a href="/admin/catalog/products" id="kt_ecommerce_edit_product_cancel" class="btn btn-light me-5">Cancel</a>
					<!--end::Button-->
					<!--begin::Button-->
							...
							(a=>{
								...
								e&&e.validate().then((function(e){
									if(document.querySelector('input[name="mainImage_remove"]').value==1)
									{
										...
										html:"Sorry, looks like thumbnail is empty, please try again.",
										icon:"error",
										buttonsStyling:!1,

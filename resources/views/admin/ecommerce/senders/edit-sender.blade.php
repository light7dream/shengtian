...
@section('content')
	<div id="kt_app_content_container" class="app-container container-xxl">
		<form id="kt_edit_sender_form" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row" data-kt-redirect="/admin/catalog/categories">
			@csrf
				...
				<div class="card card-flush py-4">
					...
					<div class="card-body text-center pt-0 fv-row">
						...
						<div class="image-input image-input-empty image-input-outline image-input-placeholder mb-3" data-kt-image-input="true">
							...
							<div class="image-input-wrapper w-150px h-150px" style="background-image: url({{url('/storage/uploads/members/senders/'.$sender->id.'.png')}})"></div>
			...
			<div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
				...
				<div class="card card-flush py-4">
					...
					<div class="card-body pt-0">
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Input-->
                            <input type="text" name="sender_name" class="form-control mb-2" placeholder="Sender name" value="{{$sender->name}}" id='sender_name' />
                            <!--end::Input-->
                            <!--begin::Description-->
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Editor-->
                            <input name="sender_phone" class="form-control mb-2" placeholder="Phone" value="{{$sender->phone}}" id='sender_phone'></textarea>
                            <!--end::Editor-->
                            <!--begin::Description-->
                        ...
                        <div class="mb-10 fv-row">
                            ...
                            <!--end::Label-->
                            <!--begin::Editor-->
                            <input name="sender_address" class="form-control mb-2" placeholder="Address" value="{{$sender->address}}" id='sender_address'></textarea>
                            <!--end::Editor-->
                            <!--begin::Description-->
				...
				<div class="d-flex justify-content-end">
					...
					<!--end::Button-->
					<!--begin::Button-->
					<button type="submit" id="kt_edit_sender_submit" class="btn btn-primary">
		...
		var KTAppEcommerceSavesender = function(){
			return{
				init:function(){
					(()=>{
						let e;
						const t=document.getElementById("kt_edit_sender_form"),
						o=document.getElementById("kt_edit_sender_submit");
						e=FormValidation.formValidation(t,{fields:{sender_name:{validators:{notEmpty:{message:"sender name is required"}}}},
						plugins:{
